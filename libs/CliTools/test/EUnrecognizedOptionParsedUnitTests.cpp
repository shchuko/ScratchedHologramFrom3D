...
namespace CliTools {
    namespace Exceptions {
        ...
        TEST(EUnrecognizedOptionParsed, EUnrecognizedOptionParsed_std_exception_inheritance_Test) {
            bool thrown;
            try {
                throw EUnrecognizedOptionParsed();
        ...
        TEST(EUnrecognizedOptionParsed, EUnrecognizedOptionParsed_test_message_with_empty_constructor) {
            bool thrown;
            try {
                throw EUnrecognizedOptionParsed();
        ...
        TEST(EUnrecognizedOptionParsed, EUnrecognizedOptionParsed_test_message) {
            bool thrown;
            std::string expected = "test message";
            try {
                throw EUnrecognizedOptionParsed(expected);
            } catch (std::exception &error) {
