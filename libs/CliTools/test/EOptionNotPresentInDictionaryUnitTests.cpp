...
namespace CliTools {
    namespace Exceptions {
        ...
        TEST(EOptionNotPresentInDictionary, EOptionNotPresentInDictionary_std_exception_inheritance_Test) {
            bool thrown;
            try {
                throw EOptionNotPresentInDictionary();
        ...
        TEST(EOptionNotPresentInDictionary, EOptionNotPresentInDictionary_test_message_with_empty_constructor) {
            bool thrown;
            try {
                throw EOptionNotPresentInDictionary();
        ...
        TEST(EOptionNotPresentInDictionary, EOptionNotPresentInDictionary_test_message) {
            bool thrown;
            std::string expected = "test message";
            try {
                throw EOptionNotPresentInDictionary(expected);
            } catch (std::exception &error) {
